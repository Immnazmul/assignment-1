...
<div class="wrap">
	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<p>
			<label><input type="checkbox" name="all_years" value="1" /> <?php esc_html_e( 'Export all years', 'fund-manager-pro' ); ?></label>
		</p>
	...
	<form method="post" enctype="multipart/form-data" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
		...
		<p><?php esc_html_e( 'CSV header: name,phone,whatsapp,monthly_amount,year,months_paid (e.g., 1|3|12)', 'fund-manager-pro' ); ?></p>
